...
type Instance struct {
	...
	VPCID              *uuid.UUID      `gorm:"type:uuid;index" json:"vpc_id,omitempty"`
	InternalIPv4       string          `gorm:"type:inet" json:"internal_ipv4,omitempty"`
	VCPU               float64         `gorm:"type:float;default:1" json:"vcpu"`
	...
	IOReadMBps         int             `gorm:"type:int;default:0" json:"io_read_mbps"`
	IOWriteMBps        int             `gorm:"type:int;default:0" json:"io_write_mbps"`
	IPv4Address        *string         `gorm:"type:inet" json:"ipv4_address,omitempty"`
	IPv6Address        *string         `gorm:"type:inet" json:"ipv6_address,omitempty"`
	PublicIPv4s        []string        `gorm:"type:jsonb" json:"public_ipv4s,omitempty"`
	IPv6Addresses      []string        `gorm:"type:jsonb" json:"ipv6_addresses,omitempty"`
	...
	PublicIPv4ID       *uuid.UUID      `gorm:"type:uuid;index" json:"public_ipv4_id,omitempty"`
	PublicIPv6PrefixID *uuid.UUID      `gorm:"type:uuid;index" json:"public_ipv6_prefix_id,omitempty"`
	...
	NATConfigs    []NATConfig    `gorm:"foreignKey:InstanceID" json:"nat_configs,omitempty"`
}
...
type NATConfig struct {
	...
	InstanceID   uuid.UUID `gorm:"type:uuid;not null;index" json:"instance_id"`
	NodeID       uuid.UUID `gorm:"type:uuid;not null;index" json:"node_id"`
	InternalIP   string    `gorm:"type:inet;not null" json:"internal_ip"`
	ExternalIP   string    `gorm:"type:inet" json:"external_ip,omitempty"`
	InternalPort int       `gorm:"type:int" json:"internal_port"`
	ExternalPort int       `gorm:"type:int" json:"external_port,omitempty"`
	Protocol     string    `gorm:"type:varchar(8);default:'tcp'" json:"protocol"`
	Description  string    `gorm:"type:varchar(255)" json:"description,omitempty"`
	CreatedAt    time.Time `gorm:"type:timestamptz;not null;default:now()" json:"created_at"`
}

func (NATConfig) TableName() string {
	return "nat_configs"
}
